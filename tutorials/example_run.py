...
sefa_object_test = SEFA(
    dataset_dir="path_to_dataset_images",
    cloud_dir="https://saliency-map-annotations.s3.amazonaws.com/imagenet_fish/",
    annotations_num=300,
    analysis_method="statistical testing",
    representation_values="binary",
    representation_option="all",
